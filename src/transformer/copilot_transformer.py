...
class CopilotTransformer(Transformer):
    ...
    def transform_chat_metrics(self, metrics_chat, aggregation_list: list[str]):
        """
    ...
    def transform_completion_metrics(self, metrics_completion, aggregation_list: list[str]):
        """
