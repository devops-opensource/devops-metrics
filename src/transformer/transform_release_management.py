...
class TransformReleaseManagement:
    ...
    def transform_release_management(self, df_versions):
        ...
        df_versions_released = common.convert_column_to_datetime("release_date", df_versions_released)
        df_versions_released = common.convert_column_to_datetime("start_date", df_versions_released)
